...
export const metadata: Metadata = {
  ...
  description:
    'Сдать анализ крови в Самаре в клинике БИОРАЙЗ можно быстро и без очередей. Результат базового исследования обычно готов за 1 день, запись онлайн или по телефону.',
