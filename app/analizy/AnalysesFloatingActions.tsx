...
export default function AnalysesFloatingActions() {
  ...
  return (
    <div ref={rootRef} className="fixed bottom-5 right-4 z-[85] flex flex-col items-end gap-3 sm:bottom-6 sm:right-6">
      <div
        className={`origin-bottom-right rounded-2xl border border-olive-primary/12 bg-white p-2 shadow-premium transition-all duration-200 ${
          isDownloadOpen
      ...
      <button
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-olive-primary text-white shadow-premium transition-all hover:-translate-y-0.5 hover:bg-olive-light"
      >
      ...
      <button
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-olive-primary/12 bg-white text-olive-primary shadow-premium transition-all hover:-translate-y-0.5 hover:bg-beige-background"
      >
        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
