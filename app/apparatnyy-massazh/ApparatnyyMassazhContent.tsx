...
const benefits = [
  {
    ...
    description:
      'Аппаратное воздействие помогает прорабатывать локальные зоны с контролируемой интенсивностью.',
  },
  {
    title: 'Комфортный формат курса',
    description:
      'Программу подбираем индивидуально: от мягкого лимфодренажа до более интенсивных протоколов.',
  },
  {
    title: 'Поддержка тонуса тела',
    description:
      'Курс направлен на улучшение внешнего вида кожи и ощущение легкости после процедур.',
  },
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-6 sm:p-8 md:p-10">
              ...
              <p className="mt-5 max-w-xl text-base leading-relaxed text-olive-primary/80 sm:text-lg">
                Современные аппаратные протоколы для коррекции контуров тела,
                улучшения качества кожи и ощущения легкости. Формат курса
