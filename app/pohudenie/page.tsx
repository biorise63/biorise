...
export const metadata: Metadata = {
  title: 'Похудение в Самаре: программы с врачом | BIORISE',
  description:
    'Три программы похудения в Самаре: чек-ап, капельницы, пептидная терапия. Эффективное снижение веса под наблюдением врача.',
