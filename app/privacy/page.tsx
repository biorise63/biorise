          ...
          <div className="prose prose-olive max-w-none text-olive-text">
            <div className="space-y-6 text-base leading-relaxed">
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  <p><strong>5.1.</strong> Имя;</p>
                  <p><strong>5.2.</strong> Номер телефона;</p>
                  <p><strong>5.3.</strong> Адрес выбранной клиники (для записи на прием);</p>
                  <p><strong>5.4.</strong> Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика, Top.Mail.Ru и других);</p>
