...
// Полная разбивка цены по дозировкам (см. Клиентикс) - рендерится отдельной
// таблицей на странице капельницы вместо одной фиксированной цены/дозы, для
// капельниц, у которых есть несколько вариантов дозировки с разной ценой.
...
const fixedPrices = {
  ...
  'Железо стандарт': { price: '5 000 ₽', duration: '60 мин' },
