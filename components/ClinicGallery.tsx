...
const galleryData: GalleryItem[] = [
  ...
  },
  {
    ...
    description:
      'Комплекс помогает оценить гормоны, щитовидную железу, витамины, биохимию и сердечно-сосудистые риски.',
    features: [
      'Более 60 лабораторных показателей',
      'Женский гормональный профиль',
      'Щитовидная железа и запасы железа',
      'Витамины, микроэлементы и биохимия',
      'Онкопрофиль и скрининг инфекций',
    ],
    price: {
      current: '31 990 ₽',
      old: '51 095 ₽',
