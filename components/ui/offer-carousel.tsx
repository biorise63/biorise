...
const offers: Offer[] = [
  ...
  },
  {
    ...
    description: 'Один укол, когда нужно поднять витамин D без долгого курса.',
    promoCode: '1 900 ₽',
    href: '/#booking',
    category: 'popular',
    price: '1 900 ₽',
  ...
  },
  {
    ...
    description: 'Курс при низком железе, слабости и падении энергии.',
    promoCode: 'от 4 500 ₽',
  ...
  },
  {
    ...
    tag: 'Популярное',
    title: 'Энергия',
    description: 'Когда сил не хватает на работу, спорт и обычный день.',
    promoCode: 'от 3 900 ₽',
  ...
  },
  {
    ...
    tag: 'Популярное',
    title: 'Детокс',
    description: 'Капельница для тех, кто хочет снять перегрузку и вернуть ясную голову.',
    promoCode: 'от 3 950 ₽',
  ...
  },
  {
    ...
    tag: 'Популярное',
    title: 'Золушка',
    description: 'Кожа выглядит свежее, а тон лица становится ровнее.',
    promoCode: 'от 4 000 ₽',
  ...
  },
  {
    ...
    tag: 'Популярное',
    title: 'Витаминная',
    description: 'Закрывает частые дефициты, когда нужен запас сил на каждый день.',
    promoCode: 'от 4 500 ₽',
  ...
  },
  {
    ...
    tag: 'Восстановление',
    title: 'Детокс',
    description: 'Помогает снять токсическую нагрузку и поддержать печень.',
    promoCode: 'от 3 950 ₽',
    href: '/kapelnicy/detoks-standart/',
    category: 'recovery',
    price: 'от 3 950 ₽',
  ...
  },
  {
    ...
    description: 'Когда после ночи без сна нужно быстро прийти в себя.',
    promoCode: 'от 2 000 ₽',
  ...
  },
  {
    ...
    tag: 'Восстановление',
    title: 'Джетлаг',
    description: 'Подходит после перелётов и резкой смены режима.',
    promoCode: 'от 2 500 ₽',
  ...
  },
  {
    ...
    tag: 'Восстановление',
    title: 'Постковид',
    description: 'Курс для восстановления сил после болезни.',
    promoCode: 'от 3 800 ₽',
  ...
  },
  {
    ...
    description: 'Курс для кожи, тонуса и более свежего внешнего вида.',
    promoCode: 'от 4 000 ₽',
    href: '/kapelnicy/krasota-i-omolozhenie/',
    category: 'beauty',
    price: 'от 4 000 ₽',
  ...
  },
  {
    ...
    tag: 'Красота',
    title: 'Густые волосы',
    description: 'Когда волосы стали слабее и хочется поддержать их изнутри.',
    promoCode: 'от 3 200 ₽',
  ...
  },
  {
    ...
    tag: 'Красота',
    title: 'Лаеннек',
    description: 'Курс для восстановления кожи и anti-age задач.',
    promoCode: 'от 5 000 ₽',
  ...
  },
  {
    ...
    description: 'Подходит, когда нужен anti-age курс для кожи и общего тонуса.',
    promoCode: 'от 5 500 ₽',
  ...
  },
  {
    ...
    description: 'Курс для женского здоровья и восстановления.',
    promoCode: 'от 3 800 ₽',
  ...
  },
  {
    ...
    tag: 'Женское здоровье',
    title: 'Маме можно',
    description: 'Состав для будущих и кормящих мам под контролем врача.',
    promoCode: 'от 3 500 ₽',
  ...
  },
  {
    ...
    description: 'Подходит на этапе планирования беременности.',
    promoCode: 'от 4 000 ₽',
  ...
  },
  {
    ...
    tag: 'Женское здоровье',
    title: 'Анти Климакс',
    description: 'Помогает пройти период менопаузы с меньшей нагрузкой на организм.',
    promoCode: 'от 4 000 ₽',
  ...
  },
  {
    ...
    description: 'Капельница после тренировок и тяжёлых нагрузок.',
    promoCode: 'от 3 500 ₽',
  ...
  },
  {
    ...
    tag: 'Спорт',
    title: 'Протеин буст',
    description: 'Подходит, когда нужно восстановление и мышечный тонус.',
    promoCode: 'от 3 500 ₽',
  ...
  },
  {
    ...
    tag: 'Спорт',
    title: 'Айронмен',
    description: 'Курс для выносливости, плотного графика и спорта.',
    promoCode: 'от 4 200 ₽',
  ...
  },
  {
    ...
    description: 'Курс для сосудов и нормальной микроциркуляции.',
    promoCode: 'от 3 000 ₽',
  ...
  },
  {
    ...
    description: 'Когда иммунитету и силам нужна подпитка.',
    promoCode: 'от 3 500 ₽',
  ...
  },
  {
    ...
    tag: 'Здоровье',
    title: 'Сахар в норме',
    description: 'Курс для тех, кто следит за сахаром и обменом веществ.',
    promoCode: 'от 3 200 ₽',
  ...
  },
  {
    ...
    tag: 'Wellness',
    title: 'Брейнсторм',
    description: 'Когда нужна ясная голова, концентрация и рабочий темп.',
    promoCode: 'от 3 600 ₽',
  ...
  },
  {
    ...
    tag: 'Wellness',
    title: 'Антистресс+',
    description: 'Помогает снять нервное напряжение и наладить сон.',
    promoCode: 'от 3 200 ₽',
  ...
  },
  {
    ...
    description: 'Много витаминов и микроэлементов в одном протоколе.',
    promoCode: 'от 4 500 ₽',
  ...
  },
  {
    ...
    tag: 'Wellness',
    title: 'Снижение веса',
    description: 'Курс для тех, кто снижает вес под наблюдением врача.',
    promoCode: 'от 3 500 ₽',
